...
RSpec.describe RecipeFood, type: :model do
  ...
  let(:recipe) { Recipe.create(title: 'Delicious Dish', description: 'A wonderful recipe', preparation_time: 30, cooking_time: 45, user: user) }
  let(:food) { Food.create(name: 'Tomato', measurement_unit: 'kg', quantity: 2, user: user) }
